...
case class Value private[data] (bytes: Bytes) {
  ...
  def toStrings(
      ...
      characterSets: CharacterSets = CharacterSets.defaultOnly
  ): Seq[String] =
  ...
  /**
    ...
    */
  def toPersonNames(vr: VR = VR.PN, characterSets: CharacterSets = CharacterSets.defaultOnly): Seq[PersonName] =
    vr match {
  ...
  /**
    ...
    */
  def toPersonName(vr: VR = VR.PN, characterSets: CharacterSets = CharacterSets.defaultOnly): Option[PersonName] =
